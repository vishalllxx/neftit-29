  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto pt-20">
      <div className="space-y-6 text-center">
        <h1 className="text-4xl sm:text-5xl font-semibold tracking-tight text-white animate-fade-in">
          Discover & Trade Premium
          <span className="text-white"> Digital Assets</span>
        </h1>

        <p className="text-lg text-[#CCCCCC] max-w-2xl mx-auto animate-fade-in [--animate-delay:200ms]">
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-4 animate-fade-in [--animate-delay:300ms]">
        <Link to="/discover">
          <Button 
            size="lg" 
            className="rounded-md text-lg px-8 py-6 bg-[#444444] hover:bg-[#555555] text-white"
          >
            Start Exploring
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-8">
        {[
          ...
          <div 
            key={stat.label}
            className="p-4 rounded-lg border border-[#333333] bg-[#222222] hover:bg-[#2a2a2a] transition-colors animate-fade-in"
